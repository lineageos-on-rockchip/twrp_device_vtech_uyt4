...
INSTALLED_SECOND_TARGET := $(BOARD_PREBUILT_SECONDIMAGE)
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) $(INSTALLED_SECOND_TARGET) \
	...
	$(hide) $(MKBOOTIMG) $(INTERNAL_RECOVERYIMAGE_ARGS) $(BOARD_MKBOOTIMG_ARGS) --second $(INSTALLED_SECOND_TARGET) --output $@
